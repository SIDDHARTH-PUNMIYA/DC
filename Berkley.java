...
we first parse it to milsecs and calc difference with server  and then calcualte aveg of the diff then we calculate the adjustment and then sync the clock
